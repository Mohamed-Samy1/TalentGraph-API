 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Ticket filter(\App\Http\Filters\V1\QueryFilter $filters)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|User filter(\App\Http\Filters\V1\QueryFilter $filters)
